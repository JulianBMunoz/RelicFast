...
fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(20, 40), sharex=True)
...
ax2.set_xlim((min(kplot), max(kplot)))
#ax2.plot([0.7*0.015, 0.7*0.015], [0.999, 1.008], color='red', label=r'$k_{eq}$')
#ax2.plot([0.024, 0.024], [0.999, 1.008], color='blue', label=r'$k_{*}$')
ax2.set_xscale('log')
ax2.set_xlabel(r'$k ~[{\rm Mpc}^{-1}]$', fontsize=40)
ax2.set_ylabel(r'$b_1^L(k)$', fontsize=40)
