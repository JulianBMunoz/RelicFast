...
(Cosmology *cosmo, double Ri, double Rpi, double delta_long, double *zlist_transfer,
double Tfm_klong, double *transfer_gamma_klong, double *transfer_nu_klong
);
...
long Nz_solution, double *R_solution, double *Mnu_solution
);
...
long Nz_solution, double *R_solution, double *Mnu1_solution, double *Mnu2_solution
);
...
long Nz_solution, double *R_solution, double *Mnu1_solution, double *Mnu2_solution, double *Mnu3_solution
);
