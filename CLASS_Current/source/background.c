...
//Julian Munoz 2017:    	
//I have added param[n_ncdm] to account for NRP neutrinos. 
//    *f0 = param[n_ncdm] * 1.0/pow(2*_PI_,3)*(1./(exp(q-ksi)+1.) +1./(exp(q+ksi)+1.));
//not necessary, since they can be recast as HDM.
